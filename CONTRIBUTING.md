...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Import-Organizer.git`
...
```bash
# Clone the repo
git clone https://github.com/Qyroxen/Import-Organizer.cd

# Install dependencies
go mod download

# Build
go build -o importorganizer .
